...
namespace M1.Test
{
    ...
    {
        private readonly Mock<ICalendarioServico> _calendarioServicoMock;
        ...
        {
            var servico = new SecretarioServico(idioma);
        ...
        {
            //arrange
            var secretarioServico = new SecretarioServico("fr_CA");
        ...
        [Theory]
        [MemberData(nameof(BoasVindasTestesGenerator.GetCasosDeTesteIdiomaEncontrado),
            MemberType = typeof(BoasVindasTestesGenerator))]
        ...
        [Theory]
        [MemberData(nameof(BoasVindasTestesGenerator.GetCasosDeIdiomaNaoEncontrado),
            MemberType = typeof(BoasVindasTestesGenerator))]
        public void BoasVinda_QuandoIdiomaNaoReconhecido_RetornaLancaExcecaoComMemberData(string idioma,
            string mensagemEsperada)
        {
            //arrange
            var secretarioServico = new SecretarioServico(idioma);
