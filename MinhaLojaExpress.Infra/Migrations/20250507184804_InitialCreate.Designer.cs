...
namespace MinhaLojaExpress.Infra.Migrations
{
    ...
    [Migration("20250507184804_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemDesconto", b =>
                {
                    b.Property<Guid>("DescontoId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MinhaLojaExpress.Dominio.Entidades.Cliente", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47b62d09-8fd6-4baf-bcfb-255168a65b45"),
            ...
            modelBuilder.Entity("MinhaLojaExpress.Dominio.Entidades.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2882d13e-d256-4ccd-a06b-54055100ec4d"),
                            Nome = "Item 1",
                            Preco = 10m,
                            Quantidade = 10L
                        });
